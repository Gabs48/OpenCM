...
ifndef ARDUINO_CORE_PATH
    ARDUINO_CORE_PATH    = $(ARDUINO_DIR)/core
endif

ifndef BOARDS_TXT
    BOARDS_TXT           = $(ARDUINO_DIR)/hw/boards.txt
endif
...
AVR_TOOLS_DIR = $(call dir_if_exists,$(ARDUINO_DIR)/tools)

# Robotis has moved the platform lib dir to their root folder
ifndef ARDUINO_PLATFORM_LIB_PATH
    ARDUINO_PLATFORM_LIB_PATH = $(ARDUINO_DIR)/lib
...
LDFLAGS += -T$(ARDUINO_DIR)/core/CM900/flash.ld
